...
class ReturnReceiptWizard(models.TransientModel):
    _name = 'return.receipt.wizard'
    _description = 'Laporan Penerimaan (RETUR) Wizard'
    ...
    def generate_report(self):
        ...
        return self.env.ref('cash_report.action_return_receipt_report').report_action(self, data=data)