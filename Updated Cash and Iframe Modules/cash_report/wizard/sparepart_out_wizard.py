...
class SparepartOutWizard(models.TransientModel):
    _name = 'sparepart.out.wizard'
    _description = 'Laporan Pengeluaran Spare Parts Wizard'
    ...
    def get_sparepart_out_data(self, data):
        ...
        query = """
            WITH move_data AS (
                ...
                WHERE 
                    ...
                    AND spt.id = %s
                    AND (sp.origin NOT ILIKE '%%Return%%' OR sp.origin IS NULL)
                    """ + product_filter + """
            )
    ...
    def generate_report(self):
        ...
        return self.env.ref('cash_report.action_sparepart_out_report').report_action(self, data=data)