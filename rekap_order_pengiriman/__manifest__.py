# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base', 'order_pengiriman', 'order_setoran', 'fleet'],
    ...
    'data': [
        ...
        'views/laporan_piutang.xml',
        'wizard/laporan_rekap_wiz.xml',
        'report/rekap_order.xml',
        'report/laporan_piutang.xml',
        'report/laporan_rekap_piutang.xml',
    ],
